    ...
    public partial class Main : Form
    {
        ...
        void newelder(object sender, KeyEventArgs op)
        {
            if (op.KeyCode == Keys.Enter)
            {
                ...
                NoteReader lo = new NoteReader(fullpath + treeView1.SelectedNode.Name + @"\" + k,fullpath, (new EncodePanel()).finalencryption(caller),pas);
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            try
            {
                ...
                NoteReader v = new NoteReader(treeView1.SelectedNode.Name, fullpath, (new EncodePanel()).finalencryption(caller),pas);
                v.Dock = DockStyle.Fill;
                splitContainer1.Panel2.Controls.Add(v);
                v.Show();
                v.Focus();
